...
import ConfdbOracleModuleLoaderPy3 as ConfdbOracleModuleLoader
...
#       "L1Trigger.L1CaloTrigger.l1tS2PFJetInputPatternWriter_cfi",
#       "FWCore.Integration.producerWithPSetDesc_cfi",
...
class ConfdbLoadParamsfromConfigs:
    ...
    def BeginJob(self):
        ...
        if(self.noload == False or self.comparetorelease != ""):
        ...
        for validatedcfipackage in validatedcfipackagelist:
            ...
            if(os.path.isdir(validatedcfisource_tree + validatedcfipackage)):
               ...
               for subdir in subdirlist:
                   ...
                   for validatedpyfile in validatedpyfiles:
#
#                      any files in cfipython to skip:
#
#                      if(validatedpyfile.find("l1tS2PFJetInputPatternWriter_cfi") != -1):
#                          continue
#                      if(validatedpyfile.find("producerWithPSetDesc_cfi") != -1):
#                          continue
...
#
    ...
    def FindParamsFromPython(self, thesubsystem, thepackage, mycomponents, componenttype, allowmultiplecfis):
        ...
        self.nesting = []
        for name, value in mycomponents.items():
            psetname = "TopLevel"

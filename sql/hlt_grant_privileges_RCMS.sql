...
GRANT SELECT ON ConfigurationStreamAssoc 	TO cms_hlt_w;
...
GRANT SELECT ON Int64ParamValues 		TO cms_hlt_w;
GRANT SELECT ON VInt64ParamValues 		TO cms_hlt_w;
GRANT SELECT ON UInt64ParamValues 		TO cms_hlt_w;
GRANT SELECT ON VUInt64ParamValues 		TO cms_hlt_w;
...
GRANT INSERT ON ConfigurationStreamAssoc        TO cms_hlt_w;
...
GRANT INSERT ON Int64ParamValues 		TO cms_hlt_w;
GRANT INSERT ON VInt64ParamValues 		TO cms_hlt_w;
GRANT INSERT ON UInt64ParamValues 		TO cms_hlt_w;
GRANT INSERT ON VUInt64ParamValues 		TO cms_hlt_w;
...
GRANT SELECT ON ConfigurationStreamAssoc        TO cms_hlt_r;
...
GRANT SELECT ON Int64ParamValues 		TO cms_hlt_r;
GRANT SELECT ON VInt64ParamValues 		TO cms_hlt_r;
GRANT SELECT ON UInt64ParamValues 		TO cms_hlt_r;
GRANT SELECT ON VUInt64ParamValues 		TO cms_hlt_r;

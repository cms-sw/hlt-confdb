...
GRANT SELECT ON Int64ParamValues 		TO cms_hlt_admin;
GRANT SELECT ON VInt64ParamValues 		TO cms_hlt_admin;
GRANT SELECT ON UInt64ParamValues 		TO cms_hlt_admin;
GRANT SELECT ON VUInt64ParamValues 		TO cms_hlt_admin;
...
GRANT INSERT ON Int64ParamValues 		TO cms_hlt_admin;
GRANT INSERT ON VInt64ParamValues 		TO cms_hlt_admin;
GRANT INSERT ON UInt64ParamValues 		TO cms_hlt_admin;
GRANT INSERT ON VUInt64ParamValues 		TO cms_hlt_admin;
...
GRANT SELECT ON ConfigurationStreamAssoc 	TO cms_hlt_writer;
...
GRANT SELECT ON Int64ParamValues 		TO cms_hlt_writer;
GRANT SELECT ON VInt64ParamValues 		TO cms_hlt_writer;
GRANT SELECT ON UInt64ParamValues 		TO cms_hlt_writer;
GRANT SELECT ON VUInt64ParamValues 		TO cms_hlt_writer;
...
GRANT INSERT ON ConfigurationStreamAssoc	TO cms_hlt_writer;
...
GRANT INSERT ON Int64ParamValues 		TO cms_hlt_writer;
GRANT INSERT ON VInt64ParamValues 		TO cms_hlt_writer;
GRANT INSERT ON UInt64ParamValues 		TO cms_hlt_writer;
GRANT INSERT ON VUInt64ParamValues 		TO cms_hlt_writer;
...
GRANT SELECT ON ConfigurationStreamAssoc        TO cms_hlt_reader;
...
GRANT SELECT ON Int64ParamValues 		TO cms_hlt_reader;
GRANT SELECT ON VInt64ParamValues 		TO cms_hlt_reader;
GRANT SELECT ON UInt64ParamValues 		TO cms_hlt_reader;
GRANT SELECT ON VUInt64ParamValues 		TO cms_hlt_reader;

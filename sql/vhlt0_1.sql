...
CREATE OR REPLACE PROCEDURE load_h_modt_parameters(parent_id IN  NUMBER)
AS
  v_parameter_id    NUMBER;
  v_parameter_type  VARCHAR2(64);
  v_parameter_name  VARCHAR2(128);
  ...
  /* cursor for parameters */
/*this is using h_ unique-zed tables*/
  CURSOR cur_parameters IS
...
/*this is using v_ tables*/
  CURSOR cur_parameters IS
    SELECT v_modtelements.id,
           paramType,
           name,
           tracked,
           ord,

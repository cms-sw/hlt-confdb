...
function WebFXColumnList() {
	...
	this.sortAscImage   = '../assets/img/asc.png';                                       // Image used to indicate ascending sort order
	this.sortDescImage  = '../assets/img/desc.png';                                      // Image used to indicate descending sort order

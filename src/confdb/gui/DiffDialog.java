...
public class DiffDialog extends JDialog {
	...
	public void jButtonLoadNewConfigActionPerformed(ActionEvent e) {
		PickConfigurationDialog dialog = new PickConfigurationDialog(jFrame, "Pick New Configuration", database);
		dialog.pack();
		...
		if (dialog.validChoice()) {
			...
			jTextFieldNewConfig
					.setText(configInfo.parentDir().name() + "/" + configInfo.name() + "/V" + configInfo.version());
	...
	public void jButtonLoadOldConfigActionPerformed(ActionEvent e) {
		PickConfigurationDialog dialog = new PickConfigurationDialog(jFrame, "Pick Old Configuration", database);
		dialog.pack();
		dialog.setLocationRelativeTo(jFrame);
		dialog.setVisible(true);
		if (dialog.validChoice()) {
	...
	public void jComboBoxOldConfigUpdate(ConfigInfo info, int selectedVersion, int maskedVersion) {
		DefaultComboBoxModel m = (DefaultComboBoxModel) jComboBoxOldConfig.getModel();
		m.removeAllElements();
		m.addElement("");
						...
						.addGroup(layout.createSequentialGroup().addGap(12)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(layout.createSequentialGroup().addComponent(jLabel1)
												...
												.addComponent(jTextFieldNewConfig, javax.swing.GroupLayout.DEFAULT_SIZE,
														638, Short.MAX_VALUE))
										.addGroup(layout.createSequentialGroup().addComponent(jLabel2).addGap(15)
												.addComponent(jComboBoxOldConfig, 0, 638, Short.MAX_VALUE)))
								.addGap(18)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addComponent(jButtonLoadOldConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(jButtonLoadNewConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addGroup(layout.createSequentialGroup().addContainerGap().addComponent(jProgressBarDiff,
								javax.swing.GroupLayout.DEFAULT_SIZE, 800, Short.MAX_VALUE)))
				.addContainerGap()));

		layout.linkSize(SwingConstants.HORIZONTAL,
				new java.awt.Component[] { jButtonLoadNewConfig, jButtonLoadOldConfig });

		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				.createSequentialGroup().addContainerGap()
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1)
						.addComponent(jTextFieldNewConfig, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jButtonLoadNewConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 24,
								javax.swing.GroupLayout.PREFERRED_SIZE))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel2)
						.addComponent(jComboBoxOldConfig, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(jButtonLoadOldConfig))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(jProgressBarDiff, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(jTabbedPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jButtonApply)
				.addComponent(jButtonClose).addContainerGap()));

		layout.linkSize(SwingConstants.VERTICAL,
				new java.awt.Component[] { jButtonLoadNewConfig, jTextFieldNewConfig });
	...
	private class DiffThread extends SwingWorker<String> {
		...
		protected void finished() {
			try {
				...
				jProgressBarDiff.setString(jProgressBarDiff.getString() + get() + " (" + elapsedTime + ")");
			} catch (ExecutionException e) {
				String errMsg = "Comparison FAILED:\n" + e.getCause().getMessage();
				JOptionPane.showMessageDialog(jFrame, errMsg, "Comparison Failed", JOptionPane.ERROR_MESSAGE, null);

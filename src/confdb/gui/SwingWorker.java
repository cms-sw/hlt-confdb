 ...
 * related version of this class is described in "The Last Word in Swing
 * Threads" in the Swing Connection.
 * <p>
...
public abstract class SwingWorker<V> implements Future<V>, Runnable {
	...
	/**
	 * Calls the <tt>construct</tt> method to compute the result, then invokes the
	 * <tt>finished</tt> method on the event dispatch thread.
	 */
	 ...
	 * <tt>construct</tt> method has returned.
	 */
	protected void finished() {
	}
	...
	/**
	 * Waits if necessary for at most the given time for this task to complete, and

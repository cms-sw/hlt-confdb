...
public class TreeTable extends JTable {
	...
	/**
	 * Stop editing the current cell manually. Bug: 75952.
	 */
	public void stopEditing() {
		if (cellEditor != null)
			cellEditor.stopCellEditing(); // Stop editing saving the value.
		// cellEditor.cancelCellEditing(); // cancel editing but does not save the
		// value.
	}
	...
	public int getEditingRow() {
		return (getColumnClass(editingColumn) == TreeTableTreeModel.class) ? -1 : editingRow;
	}
	...
	public class TreeTableTableCellRenderer extends JTree implements TableCellRenderer {
		...
		public void updateUI() {
			...
			if (treeCellRenderer instanceof DefaultTreeCellRenderer) {
				DefaultTreeCellRenderer renderer = (DefaultTreeCellRenderer) treeCellRenderer;
	 ...
	 */
	public class TreeTableTableCellEditor extends AbstractCellEditor implements TableCellEditor {
		//
		// member functions
		//
			...
			if (e instanceof MouseEvent) {
				for (int counter = getColumnCount() - 1; counter >= 0; counter--) {
					if (getColumnClass(counter) == TreeTableTreeModel.class) {
						...
						MouseEvent newME = new MouseEvent(cellRenderer, me.getID(), me.getWhen(), me.getModifiers(),

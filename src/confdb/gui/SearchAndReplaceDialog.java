...
public class SearchAndReplaceDialog extends JDialog {
	...
	public SearchAndReplaceDialog(JFrame jFrame, Configuration config) {
		...
		((JTextField) jComboBoxParameter.getEditor().getEditorComponent()).getDocument()
		...
		jTextFieldNewValue.getDocument().addDocumentListener(new DocumentListener() {
			public void insertUpdate(DocumentEvent e) {
	...
	private void search() {
		...
		// DEBUG
		System.out.println(
				"[search][INFO] " + "paramType=" + paramType + " paramName=" + paramName + " paramValue=" + paramValue);
		...
		while (itT.hasNext()) {
			...
			while (itI.hasNext()) {
				...
				if (plug0) {
					if (plug1) {
						String text = "<html>" + "<b>" + template.name() + "." + instance.name() + "</b> "
								+ "<font color=#0000ff>Plugin</font> Name (current value: " + "<font color=#ff0000>"
								+ template.name() + "</font>)" + "</html>";
				...
				for (Parameter p : params) {
					...
					if (p instanceof VPSetParameter)
						continue;
					String text = "<html>" + "<b>" + template.name() + "." + instance.name() + "</b> "
							+ "<font color=#0000ff>" + p.type() + "</font> " + p.fullName() + " " + "(current value: "
							+ "<font color=#ff0000>" + p.valueAsString() + "</font>)" + "</html>";
					m.addElement(new JCheckBox(text, true));
				}
			}
		}
	...
	private void searchAndReplace() {
		...
		if (plug0) {
			if (release.moduleTemplate(paramValue) == null)
				return;
		}
		for (int i = 0; i < m.getSize(); i++) {
			...
			String b[] = pluginDotLabel.split("<b>");
			pluginDotLabel = b[1];
			String c[] = pluginDotLabel.split("</b>");
			pluginDotLabel = c[0];
			...
			if (pluginName.equals(""))
				template = release.template(plugin);
			...
			if (template.hasInstance(label)) {
						...
						if (instance instanceof ModuleInstance) {
							...
							for (int iii = 0; iii < refCount; iii++) {
								config.insertModuleReference(parents[iii], indices[iii], newModule)
										.setOperator(operators[iii]);
							}
							String newText = "<html>" + "<b>" + newModule.template().name() + "." + newModule.name()
									+ "</b> " + "<font color=#0000ff>Plugin</font> Name (new value: "
									+ "<font color=#00ff00>" + newModule.template().name() + "</font>)" + "</html>";
				...
				try {
					...
					if (instance.updateParameter(fullParamName, paramType, paramValue)) {
						String valueAsString = instance.findParameters(fullParamName, paramType)[0].valueAsString();
						String newText = "<html>" + "<b>" + template.name() + "." + instance.name() + "</b> "
								+ "<font color=#0000ff>" + paramType + "</font> " + fullParamName + " " + "(new value: "
								+ "<font color=#00ff00>" + valueAsString + "</font>)" + "</html>";
						m.set(i, new JCheckBox(newText, true));
					}
				} catch (DataException ex) {
				}
	...
	private void jComboBoxParameterInsertUpdate(DocumentEvent e) {
		jTextFieldNewValue.setText("");
		jButtonReplace.setEnabled(false);
		if (!jTextFieldNewValue.isEnabled())
			jTextFieldNewValue.setEnabled(true);
		if (!jButtonSearch.isEnabled())
			jButtonSearch.setEnabled(true);
		resetSearchResult();
	}
	...
	private JPanel initComponents() {
		...
		jPanelSpecsLayout.setHorizontalGroup(jPanelSpecsLayout
				...
				.addGroup(jPanelSpecsLayout.createSequentialGroup()
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabelPluginType).addComponent(jComboBoxPluginType,
										javax.swing.GroupLayout.PREFERRED_SIZE, 158,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(8)
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabelPlugin).addComponent(jComboBoxPlugin, 0, 312, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabelParameter)
								.addComponent(jComboBoxParameter, 0, 312, Short.MAX_VALUE)))
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanelSpecsLayout.createSequentialGroup().addComponent(jLabelNewValue)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jTextFieldNewValue, javax.swing.GroupLayout.DEFAULT_SIZE, 716,
										Short.MAX_VALUE)));
		jPanelSpecsLayout.setVerticalGroup(jPanelSpecsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelSpecsLayout.createSequentialGroup().addGap(20)
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelPluginType).addComponent(jLabelPlugin)
								.addComponent(jLabelParameter))
						.addGap(8)
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
								.addComponent(jComboBoxPluginType, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jComboBoxPlugin, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jComboBoxParameter, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(8)
						.addGroup(jPanelSpecsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jTextFieldNewValue, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelNewValue))
						.addContainerGap()));

		jPanelSpecsLayout.linkSize(SwingConstants.VERTICAL, new java.awt.Component[] { jComboBoxParameter,
				jComboBoxPlugin, jComboBoxPluginType, jTextFieldNewValue });
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
								.addComponent(jPanelSpecs, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGap(3))
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
								.addComponent(jScrollPaneSearchResult, javax.swing.GroupLayout.DEFAULT_SIZE, 686,
										Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
										.addComponent(jButtonSelect, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonDeselect, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonSearch, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonReplace, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(jButtonOk, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
				.addContainerGap()));
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(20)
								.addComponent(jPanelSpecs, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(13)
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addGroup(layout.createSequentialGroup().addComponent(jButtonSelect)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										...
										.addComponent(jScrollPaneSearchResult, javax.swing.GroupLayout.DEFAULT_SIZE,
												270, Short.MAX_VALUE))
								.addContainerGap()));

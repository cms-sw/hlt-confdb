...
public class SaveConfigurationDialog extends JDialog {
	...
	public SaveConfigurationDialog(JFrame frame, ConfDB database, Configuration config, String comment) {
		super(frame, true);
		this.config = config;
		...
		jTreeDirectories.addMouseListener(new DirectoryTreeMouseListener(jTreeDirectories, database));
	...
	private void jTreeDirectoriesValueChanged(TreeSelectionEvent e) {
		...
		if (o instanceof Directory) {
			...
			if (selectedDir.name().split(" ").length > 1)
				selectedDir.setName(selectedDir.name().replace(" ", "_"));
	...
	private void updateOkButton() {
		...
		/*
		 * commented out to allow for insertion into existing dir/config as a new
		 * version for (int i=0;i<selectedDir.configInfoCount();i++) { if
		 * (selectedDir.configInfo(i).name().equals(configName)) {
		 * jButtonOk.setEnabled(false); return; } }
		 */
	...
	private JPanel createContentPane() {
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(layout.createSequentialGroup().addComponent(jLabel1)
										...
										.addComponent(jTextFieldConfigName, javax.swing.GroupLayout.DEFAULT_SIZE, 217,
												Short.MAX_VALUE))))
						.addGroup(layout.createSequentialGroup().addGap(91)
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(jButtonCancel, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
								.addGap(99)))
				.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(jLabel1)
						.addComponent(jTextFieldConfigName, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
				.addGap(19).addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)

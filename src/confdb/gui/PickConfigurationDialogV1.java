...
public class PickConfigurationDialogV1 extends JDialog {
	...
	public PickConfigurationDialogV1(JFrame jFrame, String title, ConfDBV1 database) {
		...
		jToggleButtonView.setIcon(new ImageIcon(getClass().getResource("/ListViewIcon.png")));
	}
	...
	private String jTableGetToolTipText(MouseEvent evt) {
		...
		text = "id:" + configVersion.dbId() + "   " + "\"" + configVersion.comment() + "\"";
		return text;
	}
	...
	private void jTreeValueChanged(TreeSelectionEvent e) {
		...
		if (o instanceof Directory) {
			...
			while (selectedIndex < 0 && iVersion < configInfo.versionCount()) {
				if (releaseTag.equals(new String()) || releaseTag.equals(configInfo.version(iVersion).releaseTag()))
			...
			jTable.getSelectionModel().setSelectionInterval(selectedIndex, selectedIndex);
	...
	private void jListMaybeShowPopup(MouseEvent e) {
		...
		if (allowUnlocking && System.getProperty("user.name").equalsIgnoreCase(configInfo.lockedByUser()))
			showPopup(e);
	}

	private void jTableValueChanged(ListSelectionEvent e) {
		if (e.getValueIsAdjusting() || configInfo == null)
			return;
		String releaseTag = (String) jComboBoxRelease.getSelectedItem();
		ListSelectionModel lsm = (ListSelectionModel) e.getSource();
		if (!lsm.isSelectionEmpty()) {
			int selectedIndex = lsm.getMinSelectionIndex();
			if (releaseTag.equals(new String()) || releaseTag.equals(configInfo.version(selectedIndex).releaseTag()))
	...
	private void jToggleButtonViewActionPerformed(ActionEvent e) {
		...
		if (b.isSelected()) {
			...
			DefaultListSelectionModel lsm = (DefaultListSelectionModel) jList.getSelectionModel();
			if (configInfo != null) {
	...
	private void showPopup(MouseEvent e) {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("Unclock does not work for Old Schema");
				// }
				// catch (DatabaseException ex) {
				String errMsg = "Failed to unlock configuration";
				JOptionPane.showMessageDialog(jFrame, errMsg, "Failed to unlock", JOptionPane.ERROR_MESSAGE);
				// ex.printStackTrace();
				// }
			}
		});
	...
	private JPanel initComponents() {
		...
		jPanelTreeLayout.setHorizontalGroup(jPanelTreeLayout
				...
				.addGroup(jPanelTreeLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelTreeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabelRelease).addComponent(jLabelFilter))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelTreeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jComboBoxRelease, 0, 241, Short.MAX_VALUE)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanelTreeLayout.createSequentialGroup()
												.addComponent(jTextFieldFilter, javax.swing.GroupLayout.DEFAULT_SIZE,
														200, Short.MAX_VALUE)
												.addGap(18).addComponent(jToggleButtonView,
														javax.swing.GroupLayout.PREFERRED_SIZE, 23,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addContainerGap())
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanelTreeLayout.createSequentialGroup()
								.addComponent(jButtonOk, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(
										jButtonCancel, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE))
				.addComponent(jScrollPaneTree, javax.swing.GroupLayout.DEFAULT_SIZE, 320, Short.MAX_VALUE));
		jPanelTreeLayout.setVerticalGroup(jPanelTreeLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanelTreeLayout.createSequentialGroup().addContainerGap()
						.addGroup(jPanelTreeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabelFilter)
								.addComponent(jToggleButtonView, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jTextFieldFilter, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelTreeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jComboBoxRelease, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jLabelRelease))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jScrollPaneTree, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanelTreeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonOk).addComponent(jButtonCancel))));

		jPanelTreeLayout.linkSize(SwingConstants.VERTICAL,
				new java.awt.Component[] { jComboBoxRelease, jTextFieldFilter });
		jPanelTreeLayout.linkSize(SwingConstants.VERTICAL, new java.awt.Component[] { jButtonOk, jToggleButtonView });
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jSplitPane, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 880,
				Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(jSplitPane, javax.swing.GroupLayout.DEFAULT_SIZE, 541, Short.MAX_VALUE));
		return jPanel;
	}

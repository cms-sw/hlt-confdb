...
public class ParameterTreeCellRenderer extends DefaultTreeCellRenderer {
	...
	private ImageIcon psetIcon = new ImageIcon(getClass().getResource("/PSetIcon.png"));

	/** icon for a vector<ParameterSet> node */
	private ImageIcon vpsetIcon = new ImageIcon(getClass().getResource("/VPSetIcon.png"));

	/** icon for any other Parameter */
	private ImageIcon parameterIcon = new ImageIcon(getClass().getResource("/ParameterIcon.png"));

...
public class ToolBar {
	...
	private void populateToolBar(CommandActionListener listener) {
		...
		jButtonNew.setIcon(new ImageIcon(getClass().getResource("/NewIcon.png")));
		...
		jButtonClose.setIcon(new ImageIcon(getClass().getResource("/CloseIcon.png")));
		...
		jButtonOpen.setIcon(new ImageIcon(getClass().getResource("/OpenIcon.png")));
		...
		jButtonSave.setIcon(new ImageIcon(getClass().getResource("/SaveIcon.png")));
		...
		jButtonMigrate.setIcon(new ImageIcon(getClass().getResource("/MigrateIcon.png")));
		...
		jButtonConvert.setIcon(new ImageIcon(getClass().getResource("/ConvertIcon.png")));
		...
		jButtonReplace.setIcon(new ImageIcon(getClass().getResource("/SearchReplaceIcon.png")));
		...
		jButtonDiff.setIcon(new ImageIcon(getClass().getResource("/DiffIcon.png")));
		...
		jButtonSmartVersions.setIcon(new ImageIcon(getClass().getResource("/DiffIcon.png")));
		...
		jButtonTrack.setToolTipText("enable/disable tracking unresolved " + "InputTags per path");
		jButtonTrack.setIcon(new ImageIcon(getClass().getResource("/TrackIcon.png")));
		...
		jButtonCloning.setIcon(new ImageIcon(getClass().getResource("/TrackIcon.png")));
		...
		jButtonConnect.setIcon(new ImageIcon(getClass().getResource("/ConnectIcon.png")));
		...
		jButtonDisconnect.setIcon(new ImageIcon(getClass().getResource("/DisconnectIcon.png")));
		...
		jButtonExport.setIcon(new ImageIcon(getClass().getResource("/ExportIcon.png")));

...
public class WorkerProgressBar extends JPanel implements ActionListener, PropertyChangeListener {
	...
	/**
	 * Invoked when task's progress property changes. Default event: Progress,
	 * State. Customised event: current (Displays the name of the current item
	 * processed
	 */
	...
	/**
	 * Create the ProgressBar window and show it. As with all GUI code, this must

...
public class PrescaleEditorConverter {
  ...
  String  pstblfile   =                  "";
	...
	try {
        ...
        //ServiceTemplate psServiceTemplate = release.serviceTemplate("PrescaleService");
        //ServiceInstance psService = new ServiceInstance("PrescaleService",psServiceTemplate);

...
public class ContainerComparison extends Comparison {
	...
	public ContainerComparison(ReferenceContainer oldContainer, ReferenceContainer newContainer) {
	...
	public ReferenceContainer oldContainer() {
		return oldContainer;
	}

	public ReferenceContainer newContainer() {
		return newContainer;
	}
	...
	public int result() {
		...
		else if (comparisonCount() == 0 && oldContainer.name().equals(newContainer.name())
	...
	public String toString() {
		return (newContainer == null) ? oldContainer.name() + " " + resultAsString() + " " + pathQualifier
				: newContainer.name() + " " + resultAsString() + " " + pathQualifier;
	}

	/** html representation of the comparison */
	public String toHtml() {
		return (newContainer == null) ? "<html><b>" + oldContainer.name() + "</b> " + " " + pathQualifier + "</html>"

...
public class ReferenceComparison extends Comparison {
	...
	public int result() {
		...
		else if (comparisonCount() == 0 && oldReference.getOperatorAndName().equals(newReference.getOperatorAndName()))
	...
	public String toString() {
		if (oldReference == null) {
			...
			return newReference.getOperatorAndName() + " [" + oldReference.getOperatorAndName() + "] "
					+ resultAsString();
		}
	...
	public String toHtml() {
		if (oldReference == null) {
			...
			return "<html><b>" + newReference.getOperatorAndName() + " [" + oldReference.getOperatorAndName()
					+ "]<b><html>";
		}
	}

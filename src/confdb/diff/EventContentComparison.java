...
public class EventContentComparison extends Comparison {
	...
	public EventContentComparison(EventContent oldEventContent, EventContent newEventContent) {
	...
	public int result() {
		...
		else if (comparisonCount() == 0 && oldEventContent.name().equals(newEventContent.name()))
	...
	public String toString() {
		return (newEventContent == null) ? "EventContent " + oldEventContent.name() + " " + resultAsString()
				: "EventContent " + newEventContent.name() + " " + resultAsString();
	}

	/** html representation of the comparison */
	public String toHtml() {
		return (newEventContent == null) ? "<html>EventContent <b>" + oldEventContent.name() + "</b></html>"

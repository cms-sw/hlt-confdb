...
abstract public class Comparison {
	...
	public static final String[] RESULTS = { "IDENTICAL", "CHANGED", "REMOVED", "ADDED" };
	...
	public boolean isIdentical() {
		return result() == RESULT_IDENTICAL;
	}
	...
	public boolean isAdded() {
		return result() == RESULT_ADDED;
	}

	/** was the first component removed? */
	public boolean isRemoved() {
		return result() == RESULT_REMOVED;
	}
	...
	public Comparison comparison(int i) {
		return comparisons.get(i);
	}

	/** get index of specified comparsion daughter */
	public int indexOfComparison(Comparison c) {
		return comparisons.indexOf(c);
	}
	...
	private void getComparisons(Iterator<Comparison> itComp, ArrayList<Comparison> comps) {
